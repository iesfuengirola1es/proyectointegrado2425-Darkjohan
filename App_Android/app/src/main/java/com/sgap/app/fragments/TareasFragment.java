...
public class TareasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        listaTareas.add(new Tarea("Pendiente", "Ejercicios de la página 23", "20/06/2025"));
        listaTareas.add(new Tarea("Completada", "Redacción sobre El Quijote", "21/06/2025"));
        listaTareas.add(new Tarea("En progreso", "Workbook unidad 4", "22/06/2025"));
